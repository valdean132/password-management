<section class="home w100 h100 display-flex space-between">
    <div class="home-main h100 display-flex flex-column overflow-y-auto">
        ...
        <div class="tabela-resumo-info marg-b-30 w100 bg-04 border-r-20 border-01 shadow-02 padd-2p marg-b-30">
            ...
            <div class="display-flex justify-end w100">
                <a href="#" class="btn-02 text-capitalize shadow-02 transition">Ver mais <i class="bi bi-arrow-right"></i></a>
            </div>
    ...
    <div class="home-secondary h100 display-flex flex-culumn padd-30 bg-04 shadow-02 overflow-y-auto">
        <div class="box-resumo w100">
            ...
            <div class="box-resumo-wrapper w100 display-flex space-between flex-wrap">
                <div class="box-resumo-single w50 padd-4p marg-b-10 cursor-pointer transition shadow-02 border-01 border-r-10">
                    <div class="box-info-icon w100 marg-b-10 display-flex align-items-center space-between transition">
                        <p class="user-select-none">10,000</p>
                        <i class="bi bi-people"></i>
                    </div><!-- Informação do Box -->
                    <div class="box-title-info w100 text-capitalize transition">
                        <h5>online agora</h5>
                    </div><!-- Titulo do box -->
                </div><!-- Box resumo unico -->
                <div class="box-resumo-single w50 padd-4p marg-b-10 cursor-pointer transition shadow-02 border-01 border-r-10">
                    <div class="box-info-icon w100 marg-b-10 display-flex align-items-center space-between transition">
                        <p class="user-select-none">10,000</p>
    ...
    </div><!-- Área de painel secundario -->
</section><!-- Sessão da Página inicial -->